			...
			this.data = shuffle([
				{
					...
					desc: 'roytampan admin themes.',
					info: '<span>Author:</span><span class="kt-font-info">Roy</span>' +
				...
				},
				{
					...
					desc: 'roytampan bootstrap themes.',
				...
				},
				{
					...
					desc: 'roytampan admin themes. Lorem Ipsum Amet.',
					info: '<span>Author:</span><span class="kt-font-info">Fly themes</span>' +
						'<span>Released:</span><span class="kt-font-info">23.08.17</span>',
					largeInfo: '<div class="kt-widget5__stats">\n' +
